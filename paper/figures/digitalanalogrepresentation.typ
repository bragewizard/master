...
#cetz.canvas(length: 1cm, {
  ...
  group({
    ...
    let trace-style = (paint: blue.darken(20%))
    ...
    line((0.68, -0.4), (1.42, -0.4), mark: (start: "|", end: "|"))
  ...
  group({
    ...
    let trace-style = (paint: green.darken(40%))
    bezier((0,0.5), (6,3), (1,3), stroke: trace-style)


    line((3, -0.4), (3.7, -0.4), mark: (start: "|", end: "|"))
