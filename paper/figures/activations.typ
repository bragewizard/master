...
#cetz.canvas(length: .7cm, {
  ...
  group({
    ...
    // Reference lines
    line((-6, 4), (6, 4), stroke: (paint: gray, dash: "dashed"))
    ...
    line(..pts, stroke: (paint: blue.darken(30%)))

    let sat_col = red.darken(60%)
    ...
    line((-6, 0.2),(-4, 0.2), stroke: (paint: sat_col, dash: "dotted"))
    line((4, 3.8),(6, 3.8), stroke: (paint: sat_col, dash: "dotted"))
    ...
    line(..d_pts, stroke: (paint: gray, dash: "dashed"))
  ...
  group({
    ...
    line((0, 0), (4.5, 4.5), stroke: (paint: blue.darken(30%)))
    line((-6, 0), (0, 0), stroke: (paint: blue.darken(30%)))

    line((0, 1.5), (7.5, 1.5), stroke: (paint: gray, dash: "dashed"))
    circle((0, 1.5), radius: 0.1, fill: white, stroke: (paint: gray))

    line((-6, 0.1), (0, 0.1), stroke: (paint: red.darken(60%), dash: "dashed"))

    content((3.5, 1.2), text(size: 8pt, fill: gray.darken(30%), [Derivative is constant 1.0]))
    content((-4, 0.4), text(size: 8pt, fill: gray.darken(30%), [Derivative is constant 0.0]))
  })
})
