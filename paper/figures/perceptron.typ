...
#cetz.canvas(length: 1cm,{
  ...
  rect((-.29,6.6),(.28,7.4), fill: blue.lighten(60%), stroke:blue.darken(50%), radius:2pt)

  rect((.7,.4),(3.3, 5.6), fill:green.lighten(50%),stroke:green.darken(50%), radius:4pt)
  rect((.5,6.6),(1.06,7.4), fill:green.lighten(60%), stroke:green.darken(50%), radius:2pt)

  rect((3.4, .4), (4.6, 5.6), fill:yellow.lighten(50%),stroke:yellow.darken(50%), radius:4pt)
  rect((4.4,6.4),(4.8,7.6), fill:yellow.lighten(60%), stroke:yellow.darken(50%), radius:2pt)
